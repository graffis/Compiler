...
public interface MicroCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MicroCParser#array_idx_2}.
	 * @param ctx the parse tree
	 */
	void enterArray_idx_2(MicroCParser.Array_idx_2Context ctx);
	/**
	 * Exit a parse tree produced by {@link MicroCParser#array_idx_2}.
	 * @param ctx the parse tree
	 */
	void exitArray_idx_2(MicroCParser.Array_idx_2Context ctx);
	/**
	 * Enter a parse tree produced by {@link MicroCParser#array_idx_1}.
	 * @param ctx the parse tree
	 */
	void enterArray_idx_1(MicroCParser.Array_idx_1Context ctx);
	/**
	 * Exit a parse tree produced by {@link MicroCParser#array_idx_1}.
	 * @param ctx the parse tree
	 */
	void exitArray_idx_1(MicroCParser.Array_idx_1Context ctx);
	/**
	 * Enter a parse tree produced by {@link MicroCParser#array_multi}.
	 * @param ctx the parse tree
	 */
	void enterArray_multi(MicroCParser.Array_multiContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroCParser#array_multi}.
	 * @param ctx the parse tree
	 */
	void exitArray_multi(MicroCParser.Array_multiContext ctx);
	/**
